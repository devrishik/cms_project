...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_user', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', unique=True, max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'User.is_staff'
        db.add_column(u'core_user', 'is_staff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.is_active'
        db.add_column(u'core_user', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'User.date_joined'
        db.add_column(u'core_user', 'date_joined',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_user', 'is_staff')

        # Deleting field 'User.is_active'
        db.delete_column(u'core_user', 'is_active')

        # Deleting field 'User.date_joined'
        db.delete_column(u'core_user', 'date_joined')
